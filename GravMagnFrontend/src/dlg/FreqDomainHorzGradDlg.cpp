...
{
    setWindowTitle(QStringLiteral("总水平方向导数"));
    setModal(true);
...
void CFreqDomainHorzGradDlg::updateDefaultSavePaths(const QString& strFilePath)
{
    ...
    mOutputFilePath = strBase + QStringLiteral("_THDR.grd");
...
void CFreqDomainHorzGradDlg::setSpinExtendSize(QSpinBox* pSpin, int nSize)
{
    if (pSpin == NULL)
    {
        return;
